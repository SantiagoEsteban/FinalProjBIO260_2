...
guinea_climate_dif <- cbind(Location=as.character(unique(guinea_weekly_cases_climate$Location)), count_week=sort(rep(75:152, 34)), tmp_dif=unlist(tmp.dif), tmx_dif=unlist(tmx.dif), tmn_dif=unlist(tmn.dif), pre_dif=unlist(pre.dif), vap_dif=unlist(vap.dif))
